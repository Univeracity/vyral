...
REQUIRED_FILES = {
    ...
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/README.md",
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/package-lock.json",
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/package.json",
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/src/object-reader.mjs",
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/src/worker.mjs",
    "src/Vyral.Cloudflare/WorkerR2GenerationProjection/verify.mjs",
    "LICENSE",
