...
Claims must be supported by evidence. This snapshot reports **1 locally conformant**, **2 prototype**, and **2 live-qualified** execution adapters across **5 tracked**.

The checked evidence baseline was generated on `2026-08-14`. Evidence is current for 90 days after its test date; a stale record remains visible but does not support a current readiness claim.
...
| Azure Durable Functions execution runtime | `Vyral.Execution.AzureDurable` | Live qualified | Live managed | 13 | 5 | `2026-08-14` | Current |
