...
Claims must be supported by evidence. This snapshot reports **1 locally conformant**, **1 prototype**, and **3 live-qualified** execution adapters across **5 tracked**.
...
| Google Firestore and Cloud Tasks execution runtime | `Vyral.Google` | Live qualified | Live managed | 12 | 6 | `2026-08-14` | Current |
