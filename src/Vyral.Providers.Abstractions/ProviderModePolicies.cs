...
public static class ProviderModePolicies
{
    public static IReadOnlyList<ProviderModePolicy> Defaults(bool allowNetwork = true)
    {
        ...
        {
            new() { Id = ProviderModes.Mechanics, AllowedOutputKinds = new List<string> { ProviderOutputKinds.Evidence, ProviderOutputKinds.Judgment }, MaxInputBytes = 32 * 1024, MaxOutputBytes = 64 * 1024, TimeoutSeconds = 60, AllowNetwork = allowNetwork },
            ...
            new() { Id = ProviderModes.Advisory, AllowedOutputKinds = new List<string> { ProviderOutputKinds.Proposal, ProviderOutputKinds.Evidence, ProviderOutputKinds.Judgment }, MaxInputBytes = 64 * 1024, MaxOutputBytes = 128 * 1024, TimeoutSeconds = 120, AllowNetwork = allowNetwork },
            ...
            new() { Id = ProviderModes.Review, AllowedOutputKinds = new List<string> { ProviderOutputKinds.Finding, ProviderOutputKinds.Evidence, ProviderOutputKinds.Question, ProviderOutputKinds.Judgment }, MaxInputBytes = 96 * 1024, MaxOutputBytes = 128 * 1024, TimeoutSeconds = 180, AllowNetwork = allowNetwork },
